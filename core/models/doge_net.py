...
__all__ = ["get_n_params", "bot_net50_l1", "bot_net50_l2", "doge_net18", "doge_net50"]
...
def bot_net50_l1(num_classes=10, args=None, **kwargs):
    in_shape = (3, 32, 32) if args.in_shape is None else args.in_shape
    return BotNet(BottleNeck, [3, 4, 6, 3], num_classes=num_classes,
                  resolution=in_shape[1], heads=4, layer3="CNN")


def bot_net50_l2(num_classes=10, args=None, **kwargs):
    in_shape = (3, 32, 32) if args.in_shape is None else args.in_shape
    return BotNet(BottleNeck, [3, 4, 6, 3], num_classes=num_classes,
                  resolution=in_shape[1], heads=4, layer3="Transformer")


def doge_net18(num_classes=10, args=None, **kwargs):
    in_shape = (3, 32, 32) if args.in_shape is None else args.in_shape
    return DogeNet(DogeNeck, [2, 3, 1, 2], num_classes=num_classes, resolution=in_shape[1], heads=4)


def doge_net50(num_classes=10, args=None, **kwargs):
    in_shape = (3, 32, 32) if args.in_shape is None else args.in_shape
    return DogeNet(DogeNeck, [6, 6, 2, 2], num_classes=num_classes, resolution=in_shape[1], heads=4)
